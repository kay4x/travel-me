...
var MobileMenu = function () {
   ...
   _createClass(MobileMenu, [{
      key: "siteHeaderEvents",
      value: function siteHeaderEvents() {
    ...
    value: function createHeaderWaypoints() {
      ...
      new Waypoint({
        ...
        handler: function handler(direction) {
          var dark = "site-header--dark";
          if (direction === "down") (0, _jquery2.default)(that.siteHeader).addClass(dark);
          if (direction === "up") (0, _jquery2.default)(that.siteHeader).removeClass(dark);
        }
      });
    }
  }, {
